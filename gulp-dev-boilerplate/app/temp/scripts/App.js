...
(0, _jquery2.default)(document).ready(function () {
    ...
    (0, _jquery2.default)('#collapse .collapse__btn').click(function () {
        (0, _jquery2.default)(this).next().slideToggle();
        (0, _jquery2.default)(this).toggleClass('show');
        var tab = (0, _jquery2.default)(this).next();
    });

    // $('.collapse').first().find('.collapse__item').show();
    // $('.collapse').first().find('.collapse__btn').addClass('show');
    (0, _jquery2.default)('#faq .collapse__btn').click(function () {
        (0, _jquery2.default)(this).next().slideToggle();
        (0, _jquery2.default)(this).toggleClass('show');
        var tab = (0, _jquery2.default)(this).next();
        (0, _jquery2.default)("#faq .collapse__item").not(tab).slideUp();
        (0, _jquery2.default)("#faq .collapse__btn").not(this).removeClass('show');
    });
});
